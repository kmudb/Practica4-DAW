...
function init() {
    ...
    if(addEventListener){
        document.getElementById('add').addEventListener('click',save,false);
        document.getElementById('get').addEventListener('click',obtain,false);
        document.getElementById('del').addEventListener('click',remove,false);
        document.getElementById('clear').addEventListener('click',clearStorage,false);

        document.getElementById('saveC').addEventListener('click',saveComplexData,false);
        document.getElementById('restoreC').addEventListener('click',restoreComplexData,false);
        document.getElementById('sArray').addEventListener('click',saveArrayData,false);
        document.getElementById('rArray').addEventListener('click',restoreArrayData,false);
    }
